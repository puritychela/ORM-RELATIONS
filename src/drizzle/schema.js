...
exports.rental = (0, pg_core_1.pgTable)("rental", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    carId: (0, pg_core_1.integer)("car_id").references(function () { return exports.car.id; }),
    customerId: (0, pg_core_1.integer)("customer_id").references(function () { return exports.customer.id; }),
...
exports.payment = (0, pg_core_1.pgTable)("payment", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    rentalId: (0, pg_core_1.integer)("rental_id").references(function () { return exports.rental.id; }),
